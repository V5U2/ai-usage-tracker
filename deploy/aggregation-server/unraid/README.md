...
`/mnt/user/Docker/ai-usage-tracker`. The container also stores its persistent
server config at `/mnt/user/Docker/ai-usage-tracker/server.toml`.
...
- Server config: `/mnt/user/Docker/ai-usage-tracker/server.toml`
